function Card({tagline="This is default tAgline", arrVal, objVal, officeCount=12}) {
    // console.log(tagline, arrVal, objVal);
    ...
    return (
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">{tagline}</h2>
          ...
          <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              <div class="flex flex-col-reverse gap-1">
                ...
                <dd class="text-4xl font-semibold tracking-tight text-white">{officeCount}</dd>
              </div>
              <div class="flex flex-col-reverse gap-1">
